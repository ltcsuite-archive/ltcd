...
<a name="BtcctlConfig" />
**2.3 Controlling and Querying ltcd via btcctl**<br />
...
**2. Add ltcd's RPC TLS certificate to system Certificate Authority list.**<br />
...
1. Copy rpc.cert to /usr/share/ca-certificates: `# cp /home/user/.ltcd/rpc.cert /usr/share/ca-certificates/ltcd.crt`<br />
2. Add ltcd.crt to /etc/ca-certificates.conf: `# echo ltcd.crt >> /etc/ca-certificates.conf`<br />
