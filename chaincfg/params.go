...
var (
	...
	mainPowLimit, _ = new(big.Int).SetString("0xfffff000000000000000000000000000000000000000000000000000000", 0)
...
var MainNetParams = Params{
	...
	BIP0034Height:            2000000,
	BIP0065Height:            2000000,
	BIP0066Height:            2000000,
	CoinbaseMaturity:         100,
	SubsidyReductionInterval: 840000,
	TargetTimespan:           time.Duration(float64(time.Hour * 24) * 3.5), // 3.5 days
	TargetTimePerBlock:       time.Duration(float64(time.Minute) * 2.5),
	...
	// Address encoding magics
	PubKeyHashAddrID:        48, // starts with L
	...
	// BIP32 hierarchical deterministic extended key magics
	HDPrivateKeyID: [4]byte{0x04, 0x88, 0xad, 0xe4}, // starts with xprv // base58Prefixes[EXT_SECRET_KEY]
	HDPublicKeyID:  [4]byte{0x04, 0x88, 0xb2, 0x1e}, // starts with xpub // base58Prefixes[EXT_PUBLIC_KEY]
